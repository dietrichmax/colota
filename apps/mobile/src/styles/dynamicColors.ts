...
export function buildDynamicColors(palette: SystemPalette, isDark: boolean): ThemeColors {
  ...
  if (isDark) {
    return {
      ...
      primaryContainer: palette.accent1_700,
      onPrimaryContainer: palette.accent1_100,
      well: palette.neutral1_700,
      background: palette.neutral1_900,
      backgroundElevated: palette.neutral1_900,
      card: palette.neutral1_800,
      surfaceRaised: palette.neutral1_800,
      surface: palette.neutral1_900,
