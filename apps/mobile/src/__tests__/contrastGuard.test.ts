...
const PAIRS: Pair[] = [
  ...
  ["textLight", "card", TEXT],
  ["text", "cardElevated", TEXT],
  ["textSecondary", "cardElevated", TEXT],
  ["primary", "cardElevated", TEXT],
  ["link", "cardElevated", TEXT],
  ["textLight", "cardElevated", UI],
  ["success", "cardElevated", UI],
  ["warning", "cardElevated", UI],
  ["error", "cardElevated", UI],
