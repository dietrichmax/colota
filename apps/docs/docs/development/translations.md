...
5. Optional: to try the translation in the app, register the language locally:
...
6. Open a pull request with the two files only, without the registration. The maintainer registers the language once its main screens are translated.
